 ...
 *  Table: 'general', 'views', 'devices', 'chart', 'texts', 'alarms', 'notifications', 'scripts', 'reports', 'locations', 'schedules'
 */
...
function _bind() {
    return new Promise(function (resolve, reject) {
        ...
        sql += "CREATE TABLE if not exists schedules (name TEXT PRIMARY KEY, value TEXT);";
